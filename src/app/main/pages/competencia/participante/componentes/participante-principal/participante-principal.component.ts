...
export class ParticipantePrincipalComponent implements OnInit {
  ...
  public formParticipanteIdentificacion: FormGroup;
  ...
  ngOnInit() {
    ...
    this.formParticipanteIdentificacion = this.formBuilder.group({
  ...
  listarParticipantePorIdentificacion() {
    // Receptar la identificación de formInscripcionCedula.value
    let participanteIdentificacionTemp = this.formParticipanteIdentificacion.value;
    this.identificacion = participanteIdentificacionTemp.identificacion;
  ...
  get identificacionField() {
    return this.formParticipanteIdentificacion.get('identificacion');
  }
